...
namespace Hexat.Editor
{
    ...
    public class Grid : MonoBehaviour
    {
        ...
        [SerializeField]
        private Vector2 cellSize = new Vector3(1, 1);
        [SerializeField]
        private int width = 1;
        [SerializeField]
        ...
        [SerializeField]
        private HorizontalPivot _horizontalPivot = HorizontalPivot.Middle;
        [SerializeField]
        private VerticalPivot _verticalPivot = VerticalPivot.Middle;
